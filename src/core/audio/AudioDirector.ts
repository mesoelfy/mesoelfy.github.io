import { IGameSystem, IServiceLocator, IPanelSystem, IGameEventService, IFastEventService, IAudioService } from '@/core/interfaces';
import { GameEvents } from '@/core/signals/GameEvents';
import { FastEvents, FX_ID_MAP } from '@/core/signals/FastEventBus';
