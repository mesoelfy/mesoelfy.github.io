  ...
  >
    <motion.div 
        ...
        exit={{ 
            scaleY: 0, 
            opacity: 0,
            // Collapses quickly AFTER icon starts leaving
            transition: { delay: 0.1, duration: 0.2, ease: "easeIn" } 
        }}
        transition={{ type: "spring", stiffness: 250, damping: 25 }}
        className="flex flex-col items-center gap-2 border-y-2 border-primary-green bg-primary-green/10 w-full py-4 relative overflow-hidden origin-center"
    >
      <motion.div 
