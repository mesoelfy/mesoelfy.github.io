...
export const WEAPONS: Record<string, WeaponDef> = {
  [WeaponIDs.PLAYER_SPITTER]: {
    ...
    visual: { model: 'SPHERE', color: PALETTE.PURPLE.PRIMARY, scale: DOT_SCALE, material: 'PROJECTILE_PLAYER' },
  ...
  [WeaponIDs.PLAYER_SNIFFER]: {
    ...
    visual: { model: 'SPHERE', color: PALETTE.PURPLE.LIGHT, scale: DOT_SCALE, material: 'PROJECTILE_PLAYER' },
  ...
  [WeaponIDs.DAEMON_ORB]: {
    ...
    visual: { model: 'SPHERE', color: PALETTE.PINK.DIM, scale: [0.5, 0.5, 0.5], material: 'PROJECTILE_ENEMY' },
    behavior: { faceVelocity: false },
    tags: [Tag.PROJECTILE, Tag.PLAYER] 
  }
};
