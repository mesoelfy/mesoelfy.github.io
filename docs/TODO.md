...
sniffer should behave like snake with 3 segments. each segment has one health. front most segment does 1 damage, and when it dies, then the next segment becomes the head/front most, but doesn't (move up) it just becomes the new front most position. User can have up to 4 sniffer snakes. Upgrades include more segments and up to 4 snakes.